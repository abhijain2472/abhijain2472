...
<head>
    ...
    <title>@yield('page-title') | Shopping</title>
    <link href="{{DIR_HTTP_VENDOR}}fontawesome-free/css/all.min.css" rel="stylesheet" type="text/css">
    <link href="https://fonts.googleapis.com/css?family=Nunito:200,200i,300,300i,400,400i,600,600i,700,700i,800,800i,900,900i" rel="stylesheet">
    <link href="{{DIR_HTTP_VENDOR}}datatables/dataTables.bootstrap4.min.css" rel="stylesheet">
    <link href="{{DIR_HTTP_CSS}}croppie.css" rel="stylesheet">
    <link href="{{DIR_HTTP_CSS}}sb-admin-2.min.css" rel="stylesheet">
    <link href="{{DIR_HTTP_CSS}}style.css" rel="stylesheet">
</head>
...
<body id="page-top">
    ...
    <div id="wrapper">
        ...
        <ul class="navbar-nav bg-gradient-primary sidebar sidebar-dark accordion" id="accordionSidebar">
            ...
            <!-- Nav Item - Dashboard -->
            <li class="nav-item @yield('active-main-dashboard')">
            ...
            <li class="nav-item @yield('active-main-category')">
                ...
                <div id="collapseTwo" class="collapse @yield('active-main-category-div')" aria-labelledby="headingTwo" data-parent="#accordionSidebar">
                    <div class="bg-white py-2 collapse-inner rounded">
                        ...
                        <a class="collapse-item @yield('active-main-category-add')" href="{{URL::to('add-category')}}">Add Category</a>
                        <a class="collapse-item @yield('active-main-category-list')" href="{{URL::to('category-list')}}">Categories</a>
                    </div>
                </div>
            </li>
        ...
        <div id="content-wrapper" class="d-flex flex-column">
            ...
            <div id="content">
                ...
                <div class="container-fluid">
                    ...
                    @if (trim($__env->yieldContent('page-description')))
                        <p class="mb-4">@yield('page-description')</p>
                    @endif
                    @if (trim($__env->yieldContent('admin-card-header')))
                        <div class="card mb-4">
                            <div class="card-header">@yield('admin-card-header')</div>
                            <div class="card-body">
                                <div class="row">
                                    <div class="col-12">@yield('admin-card-body')</div>
                                </div>
                            </div>
                        </div>
                    @endif
                    @if (trim($__env->yieldContent('admin-main-content')))
                        <div class="row">
                            <div class="col-12">
            ...
            <footer class="sticky-footer bg-white">
                <div class="container my-auto">
                    <div class="copyright text-center my-auto">
                        <span>Copyright &copy; Blog API 2020</span>
                    </div>
                </div>
            </footer>
            <!-- End of Footer -->
